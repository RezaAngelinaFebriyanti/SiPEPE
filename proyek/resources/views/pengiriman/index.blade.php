...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a class="btn btn-sm btn-primary mt-1" href="{{ url('pengiriman/create') }}">Tambah</a>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-hover table-sm" id="table_info_pengiriman">
            <thead>
                <tr>
                    <th>ID Pengiriman</th>
                    <th>Nama Toko</th>
...
<script>
    $(document).ready(function() {
        var dataPengiriman = $('#table_info_pengiriman').DataTable({
            serverSide: true,
            ajax: {
